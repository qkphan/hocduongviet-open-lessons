...
\usepackage{array,booktabs} % Kept for compatibility, though tabulars are handled carefully.
\usetheme{Madrid} % Hoặc CambridgeUS

\title[Logarit]{PHÉP TÍNH LÔGARIT (LOGARITHM). CÁC TÍNH CHẤT.}
\subtitle{Môn: Toán}
\author{Phan Quang Khánh}
\institute[THPT Phan Đăng Lưu]{TRƯỜNG THPT PHAN ĐĂNG LƯU \\ TỔ TOÁN -- TIN}
\date{}
