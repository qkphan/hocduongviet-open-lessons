...
def parse_args():
    p = argparse.ArgumentParser(
        description="Compile exam JSON to semantic LaTeX"
    )
    p.add_argument("--input", required=True, help="Path to exam.json")
    p.add_argument("--output", required=True, help="Path to output .tex")
    return p.parse_args()
